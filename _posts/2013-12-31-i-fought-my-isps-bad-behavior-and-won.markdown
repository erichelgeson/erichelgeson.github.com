...
**Edit4**: I've put up a seperate collaberative post taking the best information from all of the discussions and put them into one place. Feel free to add your own content as well: <http://erichelgeson.github.io/blog/2014/01/02/dns-security-collaborative-post/>
