...
layout: post
title: ResEdit
excerpt: ResEdit was the first tool I used to 'crack' something.
category: blog
---
...
If you had an audio CD in the drive it would play tracks 2-X because on the game CD, track 1 was the Data partition (so I didn't hear the first song on [Weezer's](http://en.wikipedia.org/wiki/Weezer_\(1994_album\)) cd much ;)
